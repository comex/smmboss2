...
# note (comex): added -gdwarf-4 to use an earlier DWARF version, because
# otherwise I get a bad backtrace in GDB for some reason :(

CFLAGS	+=	$(INCLUDE) -D__SWITCH__ -D__RTLD_6XX__ -gdwarf-4
